...
# ═════════════════════════════════════════════════════════════════════════════
# TAB 2: CATEGORY & REGION INSIGHTS
# ═════════════════════════════════════════════════════════════════════════════
with main_tab2:
...
with main_tab4:
    ...
    if cat_levels_df.empty:
        ...
        with c1:
            cov_threshold = st.number_input("Critical coverage threshold (months)", min_value=0.0, value=1.0, step=0.5, key="cat_cov_threshold")
        with c2:
    ...
    with cust_tab:
        ...
        if customer_df.empty:
            ...
            with c2:
                ...
                sort_order = st.multiselect("Filter categories", sel_categories)
